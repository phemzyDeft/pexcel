...
<div class="_2MOY8tjzab">
  <div id="MarketMenuModal" class="modal fade show" tabindex="-1" role="dialog" aria-labelledby="" style={{display: "block", paddingRight: "17px"}}>
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="_1Ke6CuvM7B modal-content">
        <div id="SocialMenuModalBody" class="_2utG0cqx22 modal-body">
          <button class="n8qbaM6QCa"><span class="fas fa-times"></span></button>
                ...
                <div class="col-6 mb-2">
                  <div class="_238wGi-h_V mr-2">
                    ...
                    <div class="ma8FYDNBdm">
                      <div class="vkCa8AmEEr"><img alt="social-icon" src="./static/media/hand.03259ee5.png" /></div>
                    ...
                    <div class="_1y-DPoKFhx">
                      <p><button class="btn btn-outline mb-1">START SHOPPING</button></p>
                    </div>
                  </div>
                </div>
                <div class="col-6 mb-2">
                  <div class="_238wGi-h_V">
                    ...
                    <div class="ma8FYDNBdm">
                      <div class="vkCa8AmEEr"><img alt="social-icon" src="./static/media/social-icons.ba0d85ca.jpg" /></div>
                      <p class="f-10">Get Real Followers, Likes, Comments, Shares, Retweets, App Reviews, Whatsapp Views etc. on your social media.</p>
                    </div>
                    <div class="_1y-DPoKFhx">
                      <p><button class="btn btn-outline mb-1">START SELLING</button></p>
                    </div>
                  </div>
                </div>
              </div>
