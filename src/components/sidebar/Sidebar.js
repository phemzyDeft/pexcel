...
const Sidebar = (props) => {
  return (
    <div className="._2k98P6lVWa">
      <div
        className="_21chLI4xNG bg-white"
        style={{ width: "280px", position: "fixed", height: "80%" }}
      >
                    ...
                    <div className="_3J87aHBaCs">
                      <div className="ud7QCJoyU6">
                        <div className="_1hrHQwVWFY">
                          <div className="_1wbTpsTsPs align-items-start">
                            <img src={earn} alt="" />
                          </div>
                        </div>
                      </div>
        ...
        <div className="_3G7L5Lphh_">
          <a
            href="https://play.google.com/store/apps/details?id=com.cheapestdatabundles.pexcel"
            className="mr-1"
            target="_blank"
          ...
          {/* <a href="https://play.google.com/store/apps/details?id=com.cheapestdatabundles.pexcel" className="h-100" target='_blank'><img src={apple_play} alt="apple-play-store" /></a>*/}
        </div>
      </div>
    </div>
  );
