                            ...
                            <div className="row">
                                <div className="col-md-12 pt-3">
                                    <div className="form-group">
                                        ...
                                        <input type="email" name='email' autofocus="" placeholder="Enter your email to for reset password" className="form-control" required="" id="id_username" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row mt-3">
                            <div className="col-12 text-center mb-3">
                                <p className="text-center">
                                    <button className="text-black ml-"><Link to="/login"><b>back to login</b></Link></button>
                                </p>
                            </div> {/*-- end col */}
                        </div>
                        {/*-- end row */}
